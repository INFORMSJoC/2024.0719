...
model.addConstr(7-x2, GRB.LESS_EQUAL, 4*x1)
model.addConstr(7-x2, GRB.GREATER_EQUAL, x1)

model.addConstr(3*(4-x2), GRB.GREATER_EQUAL, x1)
model.addConstr( 4-x2 , GRB.LESS_EQUAL, x1)

model.addConstr( 15*(4-x2) , GRB.GREATER_EQUAL, 13*x1)
